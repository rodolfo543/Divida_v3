# -*- coding: utf-8 -*-
"""
AXS Energia Unidade 06 - 2a emissao de debentures em serie unica
Calculo PMT padrao ANBIMA com projecao Focus/BCB.

Escopo desta versao
- Calcula a Serie Unica da 2a emissao da AXS 06.
- Mantem o mesmo padrao dos motores IPCA anteriores do projeto.
...
- Juros: base 252 dias uteis, com 3 incorporacoes iniciais em:
  15/09/2026, 15/03/2027 e 15/09/2027.
- Primeiro pagamento de juros e primeira amortizacao: 15/03/2028.
- Amortizacao programada em 29 parcelas semestrais ate 15/03/2043.

Premissas publicas adicionais
- Ticker adotado: AXSE12.
- ISIN adotado: BRAXSEDBS029.
- Taxa anual adotada: 10,3849% a.a., conforme informacao publica da emissao.
- Data de inicio da rentabilidade: a escritura define a data como a primeira
  integralizacao. Como esse dado nao consta de forma explicita na escritura,
  esta versao adota 13/03/2026 como premissa operacional. Se o extrato
  da Vortx ou documento de colocacao indicar outra data, ajuste o parametro
  DATA_INICIO_RENTABILIDADE abaixo e rode novamente.

Arquivos gerados
- controle_divida_axs06_v1.csv
- controle_divida_axs06_v1.xlsx
"""
...
DEBENTURE = DebentureConfig(
    nome="AXS 06 - Serie Unica",
    ticker="AXSE12",
    isin="BRAXSEDBS029",
    quantidade=Decimal("30000"),
    taxa_aa=Decimal("0.103849"),
    cronograma=[
...
def salvar_xlsx(linhas: List[Dict[str, object]], caminho: Path, titulo: str, fonte_ipca: str, observacao: str) -> None:
    ...
    tab = Table(displayName="TabelaControleAXS06", ref=ref)
...
def main() -> None:
    ...
    arquivo_csv = BASE_DIR / "controle_divida_axs06_v1.csv"
    arquivo_xlsx = BASE_DIR / "controle_divida_axs06_v1.xlsx"
    ...
    imprimir_linha("15/03/2028", linhas)
    imprimir_linha("15/03/2043", linhas)
